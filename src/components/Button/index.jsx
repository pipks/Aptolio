        ...
        <div>
          {!loading ? (
            ...
            <button
              disabled={true}
              {...rest}
              className={`bg-darkButton px-4 py-2 w-full rounded-lg duration-200 hover:bg-darkButton/70 disabled:bg-gray-500 disabled:text-gray-700 disabled:cursor-not-allowed flex items-center justify-center gap-2 ${className}`}>
