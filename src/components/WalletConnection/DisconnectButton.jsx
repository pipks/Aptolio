      ...
      <Modal title='Your Wallet' open={open} close={() => setOpen(!open)}>
        <div className='p-3'>
          <div className='border border-darkBorder w-full rounded-xl p-3'>
            ...
            <div className='flex items-center justify-between gap-3'>
              <div className='flex items-center gap-1 text-darkText font-semibold'>
                ...
                <a href={getExplorerURL('account', account.address)} target='_blank' rel='noreferrer' className='flex items-center gap-1 duration-150 cursor-pointer text-sm'>
                  View on explorer
                </a>
              </div>
          ...
          <div className='flex flex-row gap-2 justify-end mt-3'>
            ...
            <Button onClick={() => walletDisconnect()} className='bg-red-500 hover:bg-red-800'>
              DISCONNECT
            </Button>
          </div>
        </div>
